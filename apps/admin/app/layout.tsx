...
const publicThemeScriptPath = path.join(process.cwd(), "public/scripts/theme-admin.js");
const repoThemeScriptPath = path.join(process.cwd(), "apps/admin/public/scripts/theme-admin.js");
